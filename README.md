...
- Use [redux-thunk](https://github.com/reduxjs/redux-thunk) as the middleware for Redux side effects logic.
- Use [react-router-dom](https://github.com/ReactTraining/react-router/tree/master/packages/react-router-dom) to navigate between components.
